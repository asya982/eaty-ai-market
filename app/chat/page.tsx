...
const products = ['Organic Gala Apples',
  'Organic Baby Spinach',
  'Carrots',
  'Cucumber',
  'Avocado']

const history: TMessage[] = [{ sender: Sender.USER, message: "Hello, I want something healthy for today!", date: new Date("2024-12-10T09:45:00") },
{ sender: Sender.CHAT, message: "Sure, do you have any allergies I should know about?", date: new Date("2024-12-10T09:45:01") },
{ sender: Sender.USER, message: "I am allergic to nuts", date: new Date("2024-12-10T09:45:30") },
{
  sender: Sender.CHAT, message: `You can have a dinner with Fresh Spinach Salad with Avocado Dressing! 
...
const Chat = () => {
  return (
    <section className="m-6">
      ...
      <section className="bg-[url('@/assets/chat.jpg')] rounded-xl h-[73vh] overflow-auto bg-cover p-6">
      ...
      <div className="flex w-full mt-4 items-center gap-3 h-full">
        <Textarea
          ...
          max={1000}
        />
        <Button color="warning" className="text-white">Send</Button>
      </div>
    </section>
  );
};
